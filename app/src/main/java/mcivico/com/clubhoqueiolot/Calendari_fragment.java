...
public class Calendari_fragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener{

    private ListView llista;
    private SwipeRefreshLayout swipeLayout;
    private ProgressDialog dialog;
    private Calendari_fragment fragment = this;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(comprovarInternet(getContext())){
            ...
            new Calendari_task(this).execute();
    ...
    public void carregar_dades(ArrayList<Event> dades) {
        Calendari_adapter adapter_calendari = new Calendari_adapter(this.getActivity(), dades);
    ...
    public void onRefresh() {
        new Handler().postDelayed(new Runnable(){
            @Override
            public void run() {
                new Calendari_task(fragment).execute();
